...
echo "1. Pick a public GitHub repository URL"
echo "2. Use the API to create a scan:"
echo ""
echo "curl -X POST http://localhost:8000/api/v1/basic-scans \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -d '{\"repository_url\": \"https://github.com/octocat/Hello-World\", \"branch\": \"main\"}'"
echo ""
echo "========================================="
